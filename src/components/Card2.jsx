        ...
        <div  className="w-full h-[120px] p-2 shadow-lg flex justify-between">
           <div className="w-[60%] h-full   flex gap-5" >
             ...
             <div className="w-[40%] h-full flex flex-col gap-5">
                <div className="text-lg text-gray-600 fon-semibold">{name} </div>
                <div className="w-[110px] h-[50px] bg slate-400 flex rounded-lg
                overflow-hidden shadow-lg font-semibold border-2 border-green-400
                text-xl">
                  <button className=" w-[30%] h-full bg-white justify-center items-center text-green-400 
                  hover:bg-gray-400">-</button>
